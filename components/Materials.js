    ...
    <div className={materialsStyles.materials}>
      ...
      <div className={materialsStyles.display}>
        <div className={materialsStyles.material}>
          <Image src="/images/spuitkurk.png" alt="SPUITKURK" width={defaultWidth} height={defaultHeight}/>
        ...
        <div className={materialsStyles.material}>
          <Image src="/images/kurtmortel_spuitkurk.png" alt="KURKMORTEL & SPUITKURK" width={defaultWidth} height={defaultHeight}/>
        ...
        <div className={materialsStyles.material}>
          <Image src="/images/uitvlakken_spuitkurk.png" alt="UITVLAKKEN & SPUITKURK" width={defaultWidth} height={defaultHeight}/>
        ...
        <div className={materialsStyles.material}>
          <Image src="/images/isolatie_uitvlakken_spuitkurk.png" alt="ISOLATIE & UITVLAKKEN & SPUITKURK" width={defaultWidth} height={defaultHeight}/>
